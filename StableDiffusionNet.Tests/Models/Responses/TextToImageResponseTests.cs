...
{
    /// <summary>
    /// Тесты для TextToImageResponse
    /// </summary>
    public class TextToImageResponseTests
    {
        [Fact]
        public void TextToImageResponse_SerializesCorrectly()
        {
            // Arrange
            ...
            var deserialized = JsonConvert.DeserializeObject<TextToImageResponse>(json);
        ...
        [Fact]
        public void TextToImageResponse_DeserializesCorrectly()
        {
            // Arrange
            var json =
            ...
            // Act
            var response = JsonConvert.DeserializeObject<TextToImageResponse>(json);
        ...
        [Fact]
        public void TextToImageResponse_WithNullValues_SerializesCorrectly()
        {
            // Arrange
            var response = new TextToImageResponse
            {
        ...
        [Fact]
        public void TextToImageResponse_WithEmptyLists_SerializesCorrectly()
        {
            // Arrange
            var response = new TextToImageResponse
            {
        ...
        [Fact]
        public void TextToImageResponse_JsonPropertyNames_AreCorrect()
        {
            // Arrange
            var response = new TextToImageResponse
            {
        ...
        [Fact]
        public void TextToImageResponse_WithComplexParameters_SerializesCorrectly()
        {
            // Arrange
            var response = new TextToImageResponse
            {
        ...
        [Fact]
        public void TextToImageResponse_WithSingleImage_SerializesCorrectly()
        {
            // Arrange
            var response = new TextToImageResponse
            {
        ...
        [Fact]
        public void TextToImageResponse_WithMultipleImages_SerializesCorrectly()
        {
            // Arrange
            var response = new TextToImageResponse
            {
